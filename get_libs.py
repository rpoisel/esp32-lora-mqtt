...
if not os.path.exists(EXTLIBS_DIR):
    print("Cloning Arduino Crypto lib ...")
    env.Execute(
        "git clone --depth 32 https://github.com/rweather/arduinolibs " + CRYPTOLIB_DIR)
else:
    print("Checking for updates of Crypto lib ...")
    env.Execute("git --work-tree=" + CRYPTOLIB_DIR + " --git-dir=" +
                CRYPTOLIB_DIR + os.sep + ".git pull origin master --depth 32")
